...
#
# Purpose:
#   Wanted to dive into Python deeper for years I took the following
#   as my first deep dive:
...
#   the last 2 minutes, then a Pushover notification is sent with the
#   details of the activator and then I can hunt them on the reported
#   band and hopefully get them into my log as a confirmed contact and
...
#   that's another piece of technology I'd like to begin using so, there
#   you have it, Happy hunting, feel free to adapt this script in any way
#   you see fit
#
# Learning a bit in Python, so expect errors or code that is completely
# wrong; will eventually move a lot of this into classes, but that's for
# another day as is getting appropriate styling conventions.  Code is a
# maximum of 79 characters wide, will do same to comments.
#
# Sends a Pushover when any POTA activators that are from a given location.
# Only spots that happened less than 2 minutes ago are included, as well
# as we are restricted to just FT4 and FT8 modes.
# Three APIs are used:
...
#       contains the variables.  Remember, if in git, add .gitignore that
